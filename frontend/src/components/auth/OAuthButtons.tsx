...
const btnBase =
  'inline-flex items-center justify-center gap-2 rounded-2xl border border-glass-border bg-glass px-4 py-2.5 text-sm font-medium text-ink backdrop-blur-xl transition hover:bg-glass-strong disabled:cursor-not-allowed disabled:opacity-60'
